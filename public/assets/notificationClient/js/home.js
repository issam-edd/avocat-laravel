...
function openChatBox(user , authUser){
    ...
    $.ajax({
        ...
        method: 'GET',
        url: '/client/notification/checkConvo/'+user.id,
    ...
    function loadMessagesOfThisConvo(){
        ...
        $.ajax({
            ...
            method: 'GET',
            // url: '/client/notification/loadMessage/'+user.id+'/'+authUser,
            url: '/client/notification/loadMessage',
            success: function(response){
                $('#messageThread').html('');
                //console.log();
    ...
    function retrieveMessages(){
        ...
        $.ajax({
            ...
            method: 'GET',
            // url: '/client/notification/retrieveMessages/'+user.id+'/'+authUser+'/'+lastMessageId,
            url: '/client/notification/retrieveMessages/'+lastMessageId,
            success: function(response){
                //console.log(response);
...
function submitMessage(){
    ...
    $.ajax({
        ...
        url: '/client/notification/sendMessage',
        method: 'POST',
        data:{
