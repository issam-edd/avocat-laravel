...
function openChatBox(user,people , authUser){
    ...
    who.innerHTML = user.client_name;
    ...
    $.ajax({
        ...
        method: 'GET',
        url: '/lawyer/notification/checkConvo/'+user.id,
    ...
    function loadMessagesOfThisConvo(){
        ...
        $.ajax({
            ...
            method: 'GET',
            // url: '/lawyer/notification/loadMessage/'+people.id+'/'+authUser,
            // url: '/lawyer/notification/loadMessage/'+people.id,
            url: '/lawyer/notification/loadMessage/'+user.id,
            success: function(response){
                $('#messageThread').html('');
                //console.log();
    ...
    function retrieveMessages(){
        ...
        $.ajax({
            ...
            method: 'GET',
            url: '/lawyer/notification/retrieveMessages/'+user.id+'/'+lastMessageId,
            success: function(response){
                //console.log(response);
...
function submitMessage(){
    ...
    $.ajax({
        ...
        url: '/lawyer/notification/sendMessage',
        method: 'POST',
        data:{
