...
<head>
  ...
  <![endif]-->
    <title>Demande de consultation | Avocats Marrakech</title>
    <link
...
<body
    ...
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Demande de consultation.</div>
    <div role="article" aria-roledescription="email" aria-label="Demande de consultation." lang="fr"
            ...
            <tr>
                <td align="center" style="mso-line-height-rule: exactly; background-color: #eceff1; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                  <table class="sm-w-full" style="width: 600px;" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
            <td class="sm-py-32 sm-px-24" style="mso-line-height-rule: exactly; padding: 24px; text-align: center; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                <a href="https://avocatsmarrakech.com" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                <img src="https://avocatsmarrakech.com/favicon.png" width="155" alt="Avocats Marrakech" style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0;">
                </a>
            </td>
            </tr>
            <tr>
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Bonjour</p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-top: 0; font-size: 24px; font-weight: 700; color: #003582;">
                                                {{ $mailData['user']->lawyerDetail->full_name_fr ?? $mailData['user']->first_name . ' ' . $mailData['user']->last_name }}!</p>
                                            <p class="sm-leading-32"
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px; padding-bottom: 16px; border-bottom: 1px solid #d4d4d4; font-size: 18px; font-weight: 600; color: #263238;">
                                                Vous avez une nouveau question! 💬
                                            </p>

                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; font-size: 22px">
                                                {{ $mailData['question'] }}
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat',font-size: 16px; sans-serif; mso-line-height-rule: exactly;">
                                                Question de {{ $mailData['fullname'] }}.<br>
                                                Téléphone: {{ $mailData['phone'] }}<br>
                                                @if (!!$mailData['email'])
                                            ...
                                            <table style="width: 100%;" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td
                                                        style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; padding-top: 32px; padding-bottom: 16px;">
                                                        <div
