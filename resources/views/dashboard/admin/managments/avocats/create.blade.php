<x-dashboard.admin.master title="Ajouter Un Avocat">
...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Ajouter Un Avocat</li>
                    </ol>
                </div>
                <h4 class="page-title">Ajouter Un Avocat</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Ajouter Un Avocat</h4>

                    <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                            <form action="{{ route("admin.avocats.store") }}" method="post">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label for="first_name_ar" class="form-label">Nom AR</label>
                                                <input dir="rtl" autocomplete="off" type="text" name="first_name_ar"
                                                    id="first_name_ar" value="{{ old('first_name_ar') }}"
                                            ...
                                            <div class="mb-3">
                                                <label dir="rtl" for="last_name_ar" class="form-label">Prenom AR</label>
                                                <input autocomplete="off" type="text" name="last_name_ar"
                                                    id="last_name_ar" value="{{ old('last_name_ar') }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                id="bio_fr" name="bio_fr" rows="5">{{ old("bio_fr") }}</textarea>
                                                @error('bio_fr')
                                                    <div class="alert text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                id="bio_ar" name="bio_ar" rows="5">{{ old("bio_ar") }}</textarea>
                                                @error('bio_ar')
                                                    <div class="alert text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="switch4" class="form-label">Premium</label>
                                            <div>
                                                <input type="checkbox" name="is_premium"
                                                {{ old("is_premium") === "on" ? "checked" : "" }}
                                        ...
                                        <div class="mb-3">
                                            <label for="address" class="form-label">Adrress</label>
