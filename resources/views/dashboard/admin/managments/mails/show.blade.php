            ...
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="mt-3">
                                <h5 class="font-15">Email de avocat : <span class="text-muted">{{ $mail->user->last_name . " " .$mail->user->first_name }}</span> De : <span class="text-muted">{{ $mail->last_name . " " .$mail->first_name }}</span> </h5>
