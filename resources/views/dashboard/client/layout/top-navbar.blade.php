    ...
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-lg-2 gap-1">
            ...
            <div class="logo-topbar">
                <!-- Logo light -->
                <a href="{{ route("lawyer.index") }}" class="logo-light">
                    <span class="logo-lg">
                ...
                <!-- Logo Dark -->
                <a href="{{ route("lawyer.index") }}" class="logo-dark">
                    <span class="logo-lg">
        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            ...
            <li class="dropdown" >
                ...
                @endphp
                <a class="nav-link text-right dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    </span>
                    <span class="d-lg-flex flex-column gap-1 d-none">
                        <h5 class="my-0">{{ App\Models\Client::where("id",$id)->first()->client_name }}</h5>
                        <h6 class="my-0 fw-normal">Client</h6>
                    </span>
                    <span class="account-user-avatar" >
                        <img src="{{asset("images/dashboard/users/profile_default.jpg") }}" alt="user-image" width="32" class="rounded-circle avatar-sm">
                </a>
