<x-dashboard.lawyer.master title="قائمة النماذج">
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-action" id="hide">
                                                    <div class="d-flex justify-content-center">
                                                        <a  href="{{ route('download.file.uploaded', $model['path']) }}" class="btn btn-sm btn-success ms-2 d-flex align-items-center justify-content-center">
                                                            <i class="mdi mdi-cloud-download-outline"></i><span class="ms-1">WORD</span>
                                                            {{-- {{ __("model.DownloadWord") }} --}}
                                                        </a>

                                                        <a href="{{ route('lawyer.models.edit.uploaded', $model['id']) }}" class="btn btn-sm btn-warning ms-2 d-flex align-items-center justify-content-center">
    ...
    <script>
        function deleteModel(id) {
            ...
            $('#deleteModelForm').attr('action', '/lawyer/models/delete/' + id + '/uploaded'); //nhd id fl form #deleteStudentForm
        }
    </script>
