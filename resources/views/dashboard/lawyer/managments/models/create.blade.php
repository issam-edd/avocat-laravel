                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h4 style="border-bottom: 1px solid #eee;" class="mt-2 pb-2 text-center mb-3">
                                            {{-- __("model.CreateModel") --}}{{ $model->name }}</h4>
                                        <form dir="rtl" method="POST" action="{{ route('lawyer.models.store') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="model_file_id" value="{{ $model->id }}"
                                                required>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="name" class="form-label"> اسم النموذج<span
                                                ...
                                                @foreach ($model->options as $option)
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="{{ $option['option_variable'] }}"
                                                                class="form-label">{{ $option['option_name'] }}<span
                                                                    class="text-danger">*</span></label>
