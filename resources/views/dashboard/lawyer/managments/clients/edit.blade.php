...
<x-dashboard.lawyer.master title="{{ __('client.ModifyClient') }}">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">{{ __('client.ModifyClient') . " : " .$client->client_name }}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <h4 style="border-bottom: 1px solid #eee;" class="header-title mt-2 pb-2 text-center mb-3" >
                                                {{ __('client.ModifyClient') }}
                                            </h4>
                                            <form method="POST" action="{{ route("lawyer.clients.update", $client->id) }}" enctype="multipart/form-data">
                                                @method("PUT")
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control @error('client_name') is-invalid @enderror"
                                                                type="text"
                                                                name="client_name" value="{{ old("client_name", $client->client_name) }}" placeholder="{{ __('client.ClientName') }}"
                                                                id="client_name" />
                                                            @error('client_name')
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control @error('phone_number') is-invalid @enderror"
                                                                type="text"
                                                                name="phone_number" value="{{ old("phone_number", $client->phone_number) }}" placeholder="{{ __('client.PhoneNumber') }}"
                                                                id="phone_number" />
                                                            @error('phone_number')
                                                                <div class="alert text-danger">{{ $message }}</div>
                                                            @enderror
