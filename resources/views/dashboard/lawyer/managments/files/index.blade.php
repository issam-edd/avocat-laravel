<x-dashboard.lawyer.master title="{{ __('client.ListFiles') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-action" id="hide">
                                                <div class="d-flex justify-content-center">
                                                    @if ($file->fileFees->count() > 0)
                                                    <a href="{{ route("lawyer.fees.index",$file->id) }}" class="btn btn-sm btn-info ms-2 d-flex align-items-center justify-content-center">
                                                        <i class="mdi mdi-eye-outline"></i> <span class="ms-1">{{ __('client.ShowFees') }}</span>
                                                    </a>
                                                    @endif
                                                    <a href="{{ route("lawyer.fees.create",$file->id) }}" class="btn btn-sm btn-primary ms-2 d-flex align-items-center justify-content-center">
                                                        <i class="mdi mdi-pencil-plus"></i> <span class="ms-1">{{ __('client.AddFees') }}</span>
                                                    </a>
                                                    {{-- <a href="{{ route("lawyer.expenses.create",$file->id) }}" class="btn btn-sm btn-primary ms-2 d-flex align-items-center justify-content-center">
                                                        <i class="mdi mdi-pencil-plus"></i> <span class="ms-1">Add Expense</span>
                                                    </a> --}}
