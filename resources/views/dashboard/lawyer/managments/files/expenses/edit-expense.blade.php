...
<x-dashboard.lawyer.master title="{{ __('client.ModifyExpense') }}">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">{{ __('client.ModifyExpenseClient') }} : {{ $expenseFile->file->client->client_name }} {{ __('client.File') }} : {{ $expenseFile->file->avocacy_division }}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h4 style="border-bottom: 1px solid #eee;" class="header-title mt-2 pb-2 text-center mb-3" >
                                                {{ __('client.ModifyExpenseClient') }} : {{ $expenseFile->file->client->client_name }}
                                            </h4>
                                            <form method="POST" action="{{ route("lawyer.expenses.update",$expenseFile->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method("PUT")
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control @error('expense') is-invalid @enderror"
                                                                ...
                                                                name="expense" value="{{ old("expense",$expenseFile->expense) }}" placeholder="{{ __('client.expense') }}"
                                                                id="expense" />
                                                            @error('expense')
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control @error('amount') is-invalid @enderror"
                                                                type="number" maxlength="10"
                                                                name="amount" value="{{ old("amount",$expenseFile->amount) }}" placeholder="{{ __('client.advance') }}"
                                                                id="amount" />
                                                            @error('amount')
                                                                <div class="alert text-danger">{{ $message }}</div>
                                                            @enderror
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control  @error('description') is-invalid @enderror"
                                                                ...
                                                                id="description">{{ old("description",$expenseFile->description) }}</textarea>
                                                            @error('description')
                                                                <div class="alert text-danger">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control @error('image_expense') is-invalid @enderror"
                                                                type="file"
                                                                name="image_expense" value="{{ old("image_expense",$expenseFile->image_expense) }}"
                                                                id="image_expense" />
                                                            @error('image_expense')
                                                                <div class="alert text-danger">{{ $message }}</div>
                                                            @enderror
                                                            @if (!is_null($expenseFile->image_expense))
                                                                <div class="m-2" >
                                                                    <img class="avatar-xl" src="{{ asset("storage/" . $expenseFile->image_expense) }}" alt="image expense" />
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control @error('date') is-invalid @enderror"
                                                                type="date"
                                                                name="date" value="{{ old("date",$expenseFile->date) }}" placeholder="date"
                                                                id="date" />
                                                            @error('date')
                                                                <div class="alert text-danger">{{ $message }}</div>
                                                            @enderror
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <select onchange="changeForm(this.value)" class="form-control @error('type') is-invalid @enderror" name="type">
                                                                ...
                                                                <option {{ $expenseFile->type  == "Check" ? "selected" : ""}} value="1">Check</option>
                                                                <option {{ $expenseFile->type  == "Virement" ? "selected" : ""}} value="2">Virement</option>
                                                                <option {{ $expenseFile->type  == "Cash" ? "selected" : ""}}  value="3">Cash</option>
                                                            </select>
                                                            @error('type')
                                                                <div class="alert text-danger">{{ $message }}</div>
                                                            @enderror
                                                ...
                                                {{-- Form payment --}}
                                                {{-- <div id="form_payment" class="{{ in_array($expenseFile->type, ["Virement", "Check"])  ? "show-form" : "hide-form"}}"> --}}
                                                <div id="form_payment" class="{{ $expenseFile->type != "Cash"  ? "show-form" : "hide-form"}}">
                                                    <h4 style="border-bottom: 1px solid #eee;" class="header-title mt-2 pb-2 text-center mb-3" id="h4">
                                                        @if ($expenseFile->type  == "Check" )
                                                    ...
                                                    @php
                                                        $classNum = $expenseFile->type  == "Check" ? "show-form" : "hide-form" ;
                                                    @endphp
                                                    <div class="col-md-12 {{ $classNum }}" id="input_numero"  >
                                                        <div class="mb-3">
                                                            ...
                                                            @php
                                                                $numero = $expenseFile->type  == "Check" ? $expenseFile->check->numero : "";
                                                            @endphp
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            @error('image')
                                                                <div class="alert text-danger">{{ $message }}</div>
                                                            @enderror
                                                            @if (in_array($expenseFile->type, ["Virement", "Check"]) )
                                                                <div class="m-2" >
                                                                    @php
                                                                        $path = $expenseFile->type  == "Check" ? $expenseFile->check->image : $expenseFile->virement->image;
                                                                    @endphp
