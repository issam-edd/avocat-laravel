...
<x-dashboard.lawyer.master title="{{ __('client.AddFeesClient') }}">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">{{ __('client.AddFeesClient') }}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h4 style="border-bottom: 1px solid #eee;" class="header-title mt-2 pb-2 text-center mb-3" >
                                                {{ __('client.AddFeesClient') }} : {{ $file->client->client_name }}
                                            </h4>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control @error('advance') is-invalid @enderror"
                                                                ...
                                                                name="advance" value="{{ old("advance") }}" placeholder="{{ __('client.advance') }}"
                                                                id="advance" />
                                                            @error('advance')
