<x-dashboard.lawyer.master title="{{ __('client.Procedures') }}">
        ...
        <div class="row" dir="{{ $dir }}">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">{{ __('client.Procedures') }}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title" dir="{{ $dir }}">{{ __('client.Procedures') }}</h4>
                                ...
                                <table id="datatable-buttons" class="table table-centered dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('client.NombreProcedures') }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $file->procedures == NULL ? 0 : $file->procedures->count() }}</td>

                                            <td class="table-action" id="hide">
                                                <div class="d-flex justify-content-center">
                                                    @if ($file->procedures->count() != 0 )
                                                        <a href="{{ route("lawyer.procedures.all",$file->id) }}" class="btn btn-sm btn-info ms-2 d-flex align-items-center justify-content-center">
                                                            <i class="mdi mdi-eye-outline"></i> <span class="ms-1">{{ __('client.ShowProcedure') }}</span>
                                                        </a>
                                                    @endif
                                                    <a href="{{ route("lawyer.procedures.create",$file->id) }}" class="btn btn-sm btn-primary ms-2 d-flex align-items-center justify-content-center">
                                                        <i class="mdi mdi-pencil-plus"></i> <span class="ms-1">{{  __('client.AddProcedure') }}</span>
                                                    </a>
