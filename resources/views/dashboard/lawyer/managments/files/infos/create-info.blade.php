<x-dashboard.lawyer.master title="{{ __('client.AddInfo') }}">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">{{ __('client.AddInfoClient') }} : {{ $file->client->client_name }} </h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h4 style="border-bottom: 1px solid #eee;" class="header-title mt-2 pb-2 text-center mb-3" >
                                            ...
                                            class="text-muted"></span>{{ $file->client->client_name }} {{ __('client.File') }} :
                                            <span class="text-muted">{{ $file->avocacy_division }}</span>
                                        </h4>
                                        <form method="POST" action="{{ route('lawyer.infos.store', $file->id) }}"
                                            ...
                                            {{-- <div class="row" id="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <button type="button" class="btn btn-primary" onclick="addFile()">{{ __('client.Add') }}</button>
                                                    </div>
                                                </div>
                                            </div> --}}
    ...
    <script>
        ...
        function deleteFile(file) {
            // file.parentNode.parentNode.parentNode?.remove();
