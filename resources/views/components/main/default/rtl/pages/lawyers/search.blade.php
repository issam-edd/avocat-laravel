                    ...
                    <div class="row no-gutters">
                        <div class="col-xl-10 col-lg-9 col-md-8 col-sm-12 col-12">
                            <div class="form-group mb-0 position-relative">
                                ...
                                <input type="text" name="term" class="form-control sm right-ico" placeholder="اسم المحامي، نوع التخصص..." required />
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-12 col-12">
                            <div class="form-group mb-0 position-relative">
                                <button class="search-btn btn full-width custom-height sm bg-dark text-white fs-md" type="submit">ابحث</button>
                            </div>
                        </div>
                    </div>
                </form>
