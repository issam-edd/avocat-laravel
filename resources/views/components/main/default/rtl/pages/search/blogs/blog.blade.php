            ...
            <div class="cats-box rounded bg-white d-flex align-items-start">
                ...
                <div class="cats-box-caption px-2">
                    <h3 class="fs-md mb-1 ft-medium blog-title-overview">
                        <a href="{{ route('lawyers.blogs.show', [ 'blog' => $blog->id, 'slug' => $blog->user->lawyerDetail->slug ]) }}">
                    ...
                    <p class="blog-body-overview">
                        ...
                        <div class="lawyer-card-cta mt-2">
                            <div class="text-left mlb-last">
                                <a href="{{ route('lawyers.blogs.show', [ 'blog' => $blog->id, 'slug' => $blog->user->lawyerDetail->slug ]) }}" class="btn gray ft-medium apply-btn fs-sm rounded rtl-link">أكمل القرائة<i class="lni lni-arrow-left ml-1"></i></a>
                            </div>
                        </div>
                </div>
            </div>
