                    ...
                    <div class="row no-gutters">
                        <div class="col-xl-10 col-lg-9 col-md-8 col-sm-8 col-8">
                            <div class="form-group mb-0 position-relative">
                                ...
                                <input type="text" value="{{ $data['term'] ?? '' }}" name="term" class="form-control sm left-ico !tw-ring-transparent " placeholder="{{ __('siteweb.search_placeholder') }}" required />
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-4">
                            <div class="form-group mb-0 position-relative">
                                <button class="search-btn btn full-width custom-height sm bg-dark text-white fs-md" type="submit">
                                    <i class="bnc-ico lni lni-search-alt tw-text-white tw-text-lg"></i>
                                    {{-- {{ __('siteweb.search') }} --}}
                                </button>
                            </div>
                        </div>
