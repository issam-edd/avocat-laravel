        ...
        <div class="row justify-content-center mb-5">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="sec_title position-relative text-center mb-4">
                    <h2 class="ft-bold text-muted tw-text-2xl">{{ __('siteweb.questions') }} <span class="theme-cl-s">{{ __('siteweb.and_responses')  }}</span></h2>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6 w-100 row align-items-start justify-content-start">
                @foreach($phase1 as $lawyer1)
                    <div class="col-xl-12 px-0 px-md-2 col-lg-12 col-md-12 col-sm-12">
                        <x-main.default.ltr.pages.faq.faq-item :data="['lawyer' => $lawyer1]" />
                    </div>
                @endforeach
            </div>
            <div class="col-lg-6 w-100 row align-items-start justify-content-start">
                @foreach($phase2 as $lawyer2)
                    <div class="col-xl-12 px-0 px-md-2 col-lg-12 col-md-12 col-sm-12">
                        <x-main.default.ltr.pages.faq.faq-item :data="['lawyer' => $lawyer2]" />
                    </div>
                @endforeach
            </div>
        </div>
    </div>
    <x-main.default.ltr.global.pagination :data="[ 'links' => $data['lawyers'] ]" />
</section>
<!-- ======================= FAQ's End ======================== -->
