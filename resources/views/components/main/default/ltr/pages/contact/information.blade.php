...
<div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
    <div class="card-wrap-body mb-4 gray rounded p-3">
        <h4 class="ft-medium mb-3 theme-cl-s">{{ __('siteweb.address') }}</h4>
        <p>{{ $options['localisation'] }}</p>
    </div>

    <div class="card-wrap-body mb-3 gray rounded p-3">
        <h4 class="ft-medium mb-3 theme-cl-s">{{ __('siteweb.phone') }}</h4>
    ...
    <div class="card-wrap-body mb-3 gray rounded p-3">
        <h4 class="ft-medium mb-3 theme-cl-s">{{ __('siteweb.email') }}</h4>
