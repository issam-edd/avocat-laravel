<head>
    ...
    <!-- Meta tags -->
    <meta charset="utf-8">
    <meta name="description" content="{{ $main_options['description_fr'] ?? '' }}">
    <meta name="keywords" content="{{ $main_options['keywords_fr'] ?? '' }}">
    ...
    <link href="{{ asset('assets/main/lawyer/css/ltr.css') }}" rel="stylesheet">
    ...
    <title>{{ $title }} | {{ !!$lawyer->full_name_fr ? $lawyer->full_name_fr : $lawyer->user->first_name . ' ' . $lawyer->user->last_name }}</title>
