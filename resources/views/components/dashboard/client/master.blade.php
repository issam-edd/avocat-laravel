...
<html lang="en" data-layout="topnav">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <!-- End Preloader-->
            <!-- ========== Topbar Start ========== -->
            @include("dashboard.client.layout.top-navbar")
            {{-- top-navbar --}}
            <!-- ========== Topbar End ========== -->

            <!-- ========== Horizontal Menu Start ========== -->
            @include("dashboard.client.layout.navbar")
            {{--  --}}
            <!-- ========== Horizontal Menu End ========== -->
            ...
            <div class="content-page">
                ...
                <!-- Footer Start -->
                @include("dashboard.client.layout.footer")
        ...
        <!-- END wrapper -->
        @include("dashboard.client.layout.script")
